...
async function mostrarPersonas() {
  ...
  for (const persona of personas) {
    ...
    // Obtiene todas la celdas <td> dentro del clon
    ...
    // Buscar los botones de editar y eliminar dentro del clon
    const btnEditar = clone.querySelector('.btn-editar');
    const btnEliminar = clone.querySelector('.btn-eliminar');

    // Asigna el evento de click al boton de editar, llamando a la funcion con el ID de la persona
    btnEditar.addEventListener('click', () => editarPersona(persona.id_persona));

    // Asigna el evento de click al boton de eliminar, llamando a la funcion con el ID de la persona
    btnEliminar.addEventListener('click', () => eliminarPersona(persona.id_persona));

    // Finalmente, agregar la fila clonada (con datos y botones configurados) al cuerpo de la tabla
